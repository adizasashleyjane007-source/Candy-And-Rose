    ...
    useEffect(() => {
        const loadProfile = async () => {
            try {
                ...
                if (dbProfile) {
                    const loadedProfile = {
                        name: dbProfile.name || user.email?.split('@')[0] || 'Admin User',
                        email: dbProfile.email || user.email || 'admin@candyandrose.com',
                        phone: dbProfile.phone || '09123456789',
                        role: dbProfile.role || 'Administrator',
                        bio: dbProfile.bio || '',
                        image: dbProfile.image_url || '/LOGO.jpg',
                    };
                    setProfile(loadedProfile);
                    localStorage.setItem('salon_admin_profile', JSON.stringify(loadedProfile));
                }
            } catch {}
        };
        loadProfile();
            ...
            if (userId) {
                ...
                await supabase
                    ...
                    .update({
                        ...
                        role: profile.role,
                        bio: profile.bio,
                        image_url: profile.image === '/LOGO.jpg' ? null : profile.image,
                        updated_at: new Date().toISOString(),
                    })
                    .eq('id', userId);
            }
            localStorage.setItem('salon_admin_profile', JSON.stringify(profile));
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-gradient-to-br from-pink-50 via-white to-pink-100 overflow-y-auto w-full max-w-full">
            ...
            <div className="px-8 pb-8 flex-1 max-w-7xl mx-auto w-full mt-2">
                <div className="mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Admin Profile</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 h-full">
                        {/* Profile Photo Card */}
                        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-pink-100 flex flex-col items-center text-center h-full">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-pink-100">
                ...
                <div className="mt-8">
                    <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-pink-100">
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="flex justify-end pt-4">
                                <button type="button" className="px-8 py-3 bg-gray-900 hover:bg-black text-white rounded-full font-bold shadow-md transition-all hover:scale-[1.02]">
                                    Update Password
                                </button>
                            </div>
                        </form>
